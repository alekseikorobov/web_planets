...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        ...
        this.startAnimation = function () {
            _this.cx.beginPath();
            _this.cx.clearRect(-400, -400, _this.width + 400, _this.height + 400);
            _this.planet1.nextPosition();
            _this.planet1.render(_this.cx);
            _this.planet2.nextPosition();
            _this.planet2.render(_this.cx);
            _this.planet3.nextPosition();
            _this.planet3.render(_this.cx);
            _this.cx.moveTo(_this.centerX, _this.centerY);
            _this.cx.ellipse(_this.centerX, _this.centerY, 20 * _this.scale, 20 * _this.scale, 0, 0, 2 * Math.PI);
            _this.cx.fill();
            _this.cx.closePath();
            requestAnimationFrame(_this.startAnimation);
        };
    }
    AppComponent.prototype.ngAfterViewInit = function () {
        ...
        this.planet1 = new Planet({ x: this.centerX, y: this.centerY }, this.scale);
        this.planet1.radius = 80;
        this.planet1.speed = 0.02;
        this.planet1.size = 10;
        this.planet2 = new Planet({ x: this.centerX, y: this.centerY }, this.scale);
        this.planet2.radius = 120;
        this.planet2.speed = 0.04;
        this.planet2.size = 10;
        this.planet3 = new Planet({ x: this.centerX, y: this.centerY }, this.scale);
...
var Planet = /** @class */ (function () {
    ...
    Planet.prototype.nextPosition = function () {
        this.angle += this.speed;
        if (this.angle > 2 * Math.PI)
            this.angle = 0;
        this.setPosition();
    };
    Planet.prototype.render = function (cx) {
        //cx.beginPath()
